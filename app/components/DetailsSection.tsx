  ...
  return (
    <div className="relative bg-grayColor px-4 pb-4 overflow-hidden">
      ...
      <div className="flex w-full justify-center">
        <Reveal>
          <p className="text-white max-w-md text-center my-8 font-montserrat font-semibold text-sm">
            ...
            Bapak/Ibu/Saudara/I berkenan untuk memberikan doa restu kepada kedua
            mempelai.
          </p>
        </Reveal>
      </div>
      <div className="bg-creamColor relative h-full w-full rounded-[36px] bg-repeat">
        <div
          className="absolute w-full h-full mix-blend-multiply bg-center bg-repeat rounded-[36px]"
        ...
        <div className="w-full min-h-fit flex flex-col items-center">
          <div className="flex flex-col md:flex-row gap-8 md:gap-0 w-full justify-evenly items-center text-grayColor mt-16 px-2 z-20">
            <div className="flex flex-col justify-center items-center">
              <Reveal delay={1.2}>
                <Image src={muslimah} alt="muslimah" />
              </Reveal>
              <Reveal delay={1.2}>
                <h1 className="font-avigea text-xl text-center mt-3">
                  Tri Nurhartati
                </h1>
              </Reveal>
              <Reveal delay={1.2} direction="x">
                <Image src={separator} alt="line" />
              </Reveal>
              <Reveal delay={1.2}>
                <p className="font-montserrat text-xs  text-center font-semibold">
                  Putri ketiga dari <br />
                  Bapak M. Harmadi{' '}
                  <span className="font-kufi">رَحِمَهُ اللهُ</span> & Ibu Penih
                </p>
              </Reveal>
            </div>
            <div className="flex flex-col justify-center items-center">
              <Reveal delay={1.3}>
                <Image src={muslim} alt="muslimah" />
              </Reveal>
              <Reveal delay={1.3}>
                <h1 className="font-avigea text-xl text-center mt-3">
                  Daris Reyhan Muhammad
                </h1>
              </Reveal>
              <Reveal delay={1.3} direction="x">
                <Image src={separator} alt="line" />
              </Reveal>
              <Reveal delay={1.3}>
                <p className="font-montserrat text-xs  text-center font-semibold">
          ...
          <div className="flex flex-col justify-center items-center text-grayColor mt-12 px-2 z-20">
            <h3 className="font-montserrat text-center text-sm mt-12 max-w-md font-semibold">
              <Reveal>
                Dengan memohon Ridho Rahmat Allah{' '}
                <span className="text-xl font-normal">ﷻ</span>, kami bermaksud
                menyelenggarakan acara pernikahan kami.
              </Reveal>
            </h3>
            <h3 className="font-montserrat text-center text-sm mt-4 max-w-md font-semibold">
              <Reveal>Yang insyaallah akan diselenggarakan pada</Reveal>
            </h3>

            <Reveal>
              <div className="grid grid-flow-row-dense grid-cols-1 mt-4">
                <div className=" text-center font-montserrat font-semibold text-xl py-2">
                  Sabtu
                </div>
            ...
            <Reveal>
              <a
                href="https://www.google.com/maps/place/6%C2%B015'30.6%22S+107%C2%B005'43.8%22E/@-6.2585034,107.0929222,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.2585034!4d107.0954971?hl=en&entry=ttu"
                target="_blank"
              >
            ...
            <Reveal>
              <p className="font-montserrat text-grayColor text-center text-sm max-w-xs font-semibold">
                Atas kehadiran dan doa kami ucapkan Jazakumullahu khaira.
              </p>
            </Reveal>
          </div>
